...
import { getAlliHours, createIntegrationHour, updateIntegrationHour, deleteIntegrationHour } from '../../services/hours/iHourService'
...
export default function IntegrationHours({ globalFilter }) {
