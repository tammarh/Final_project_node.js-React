...
import { getAllpHours ,deletePersonalBasketHours} from '../../../services/hours/pHourService'
import { Dialog } from 'primereact/dialog'
import { Button } from 'primereact/button'
import UpdatePHour from './UpdatePhour'
...
export default function PersonalBasketHours({ globalFilter }) {
    ...
    return (
        <div className="card"  >
            ...
            <UpdatePHour updateVisible={updateVisible} 
