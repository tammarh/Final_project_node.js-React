...
const TeachingHoursSchema = new mongoose.Schema({
    ...
    source:{
       // numSrc:{type:Number,enum:[5,6,25,16]}, -- אם עושים  2 enum צריך אח"כ ב middelware לעשות בדיקות התאמה
        nameSrc:{type:String,enum:['5 - סל עדיפות','6 - תקן בסיסי חנ"מ לקויות מורכבות','25 - בסיסי חנ"מ רגיל לקויות קלות','16 - סל שח"מ']},
        required:true
    },
    // (מספר ושם) ייעוד
    designation:{
        //numDes:{type:Number,enum:[11,85,1,18,19,20,1,18,19,20,90,91,99]}, -- אם עושים 2 enum צריך אח"כ ב middelware לעשות בדיקות התאמה
        name:{type:String,enum:['11 - יוח"א','85 - ניהול','1 - תוכניות לימודים','18 - חינוך', '19 - ניהול','20 - יעוץ',
            '1 - תוכניות לימודים','18 - חינוך','19 - ניהול','20 - יעוץ','90 - רופא','91 - פרא רפואי','99 - אחות']},
        required:true
